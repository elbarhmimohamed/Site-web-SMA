...
<html >
  ...
  <path fill-rule="evenodd" d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555zM0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757zm3.436-.586L16 11.801V4.697l-5.803 3.546z"/>
        ...
        <h3>Bureaux </h3> <br>
        <p>
                22,bD Chabi 3<sup>éme</sup> Etage <br>
                Lot Lotf Beni Mellal <br>
                Maroc <br><br>
                Tél : +212 523 48 48 33  <br> 
                Fax : 0523489990 <br>
                Email : Afriquemaisonsarl@gmail.com<br>
                </p>
                
                 <center><h3>A PROPOS DE STEMA : </h3></center> <br>
                <DIV class="ptxt">
                    <br><br> 
                    STE Maison d'Afrique opère dans le secteur de la construction depuis 2006. L'entreprise opère dans tout le Maroc,
                    principalement avec des clients d'institutions privées et publiques.
                    La satisfaction de nos clients nous a permis de progresser dans un contexte ouvert et concurrentiel. <br></B>
                </DIV>
                <div class="imgg">
                    
                    
                    <img src="img/propos_img.jpg" alt="Girl in a jacket" width="400" height="250"> 
                    </div>
        </div>
